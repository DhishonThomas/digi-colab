  ...
  const handleCreateOrUpdate = async () => {
    ...
    try {
      ...
      form.append(
        "jobRoles",
        selectedJobRoleId ||
          selectedCourse?.jobRoles?.[0]?.id ||
          courses[0]?.jobRoles?.[0]?.id
      );
    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="px-5 py-2 rounded-md bg-[#B56365] text-white hover:bg-[#b56364f8]"
        >
          + Add Course
        </button>
      </div>
      ...
      {paginateData.length === 0 ? (
        <NoData
          ...
          description="There are currently no courses to display. Please add a new course or check back later."
          actionText="Add a New Course"
        />
      ) : (
        <div>
          ...
          <div className="w-full max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1 space-y-2">
                <h3 className="text-base mt-1 font-bold text-gray-700">
                  Select Job Role
                </h3>
          ...
          <div className="space-y-8 rounded-xl bg-white bg-[url('/images/watermark_logo.png')] bg-center bg-no-repeat bg-contain border border-gray-200 ">
            ...
            {selectedCourse.jobRoles && (
              <p className="text-xl font-bold text-gray-600">
                Job Role: {selectedCourse?.jobRoles[0]?.roleName}
              </p>
            )}
          </div>
        </Modal>
